...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://edu.magedu.com/", "gupao_edu_college_token", "TOKEN1")
	got, err := (&Magedu{}).Extract("https://edu.magedu.com/course/vip/1001", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatalf("Extract returned error: %v", err)
	}
	goldenAssertMedia(t, "magedu", got)
}
