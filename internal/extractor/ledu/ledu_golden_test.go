...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://app.ledupeiyou.com/", "stuId", "STU1")
	goldenSetCookie(t, jar, "https://app.ledupeiyou.com/", "token", "TOKEN1")
	got, err := (&Ledu{}).Extract("https://app.ledupeiyou.com/classroom/CLASS1", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatalf("Extract returned error: %v", err)
	}
	goldenAssertMedia(t, "ledu", got)
}
