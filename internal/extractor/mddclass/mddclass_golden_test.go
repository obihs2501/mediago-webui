...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://lexue.mddclass.com/", "uid", "USER1")
	got, err := (&Mddclass{}).Extract("https://lexue.mddclass.com/series/5001", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
