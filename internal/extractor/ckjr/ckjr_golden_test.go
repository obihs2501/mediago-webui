...
func TestExtractMock(t *testing.T) {
	...
	ext, err := extractor.Match("https://kpapiop.ckjr001.com/kpv2p/app#/homePage/course/video?courseId=1001")
	if err != nil {
		t.Fatalf("extractor pattern should match fixture URL: %v", err)
	}
	info, err := ext.Extract("https://kpapiop.ckjr001.com/kpv2p/app#/homePage/course/video?courseId=1001", nil)
	if err == nil {
