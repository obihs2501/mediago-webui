...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://www.luffycity.com/", "luffy-client-key", "TOKEN1")
	got, err := (&Luffycity{}).Extract("https://www.luffycity.com/course/detail/1001/", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatalf("Extract returned error: %v", err)
	}
	goldenAssertMedia(t, "luffycity", got)
}
