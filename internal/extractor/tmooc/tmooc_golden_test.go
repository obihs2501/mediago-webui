...
func TestExtractMock(t *testing.T) {
	...
	ext, err := extractor.Match("https://tts10.tmooc.cn/#/course?courseId=1001")
	if err != nil {
		t.Fatal(err)
	}
	info, err := ext.Extract("https://tts10.tmooc.cn/#/course?courseId=1001", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatal(err)
	}
	if info == nil {
