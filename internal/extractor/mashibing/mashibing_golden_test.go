...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://www.mashibing.com/", "sid", "SID1")
	got, err := (&Mashibing{}).Extract("https://www.mashibing.com/course/1001", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatalf("Extract returned error: %v", err)
	}
	goldenAssertMedia(t, "mashibing", got)
}
