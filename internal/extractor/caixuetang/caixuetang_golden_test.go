...
func TestExtractMock(t *testing.T) {
	...
	ext, err := extractor.Match("https://www.caixuetang.cn/course/detail/1001?course_id=1001")
	if err != nil {
		t.Fatalf("extractor pattern should match fixture URL: %v", err)
	}
	info, err := ext.Extract("https://www.caixuetang.cn/course/detail/1001?course_id=1001", nil)
	if err == nil {
