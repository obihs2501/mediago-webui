...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://m.lizhiweike.com/", "token", "TOKEN1")
	goldenSetCookie(t, jar, "https://m.lizhiweike.com/", "id", "WID1")
	got, err := (&Lizhiweike{}).Extract("https://m.lizhiweike.com/channel/123", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
