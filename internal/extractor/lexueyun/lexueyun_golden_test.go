...
func TestExtractMock(t *testing.T) {
	...
	jar := goldenNewJar(t)
	goldenSetCookie(t, jar, "https://my.lexue-cloud.com/", "lexueyun-pc-userAuth", "AUTH1")
	got, err := (&Lexueyun{}).Extract("https://my.lexue-cloud.com/subject/1001?ordSerialNo=ORD1", &extractor.ExtractOpts{Cookies: jar})
	if err != nil {
		t.Fatalf("Extract returned error: %v", err)
	}
	goldenAssertMedia(t, "lexueyun", got)
}
